...
function AccordionInfo({ label, value, t }) {
  ...
  return (
    <div
      style={{ borderBottom: `1px solid ${t.accordionBorder}` }}
    ...
    >
      ...
      >
        <span>{label}</span>
        <ChevronDown
          className={`w-4 h-4 transition-transform duration-250 ${open ? "rotate-180" : ""}`}
      ...
      >
        <div className="overflow-hidden">
          <p
            className="pb-3 text-xs leading-relaxed"
            style={{ color: t.accordionValueColor }}
          >
            {value}
          </p>
        </div>
...
export default function ProductDetailPage() {
  ...
  if (loading) {
    return (
      ...
      >
        <p className="text-sm" style={{ color: t.metaColor }}>
          Đang tải sản phẩm...
        </p>
      </main>
    );
    ...
    return (
      ...
      >
        <div className="text-center">
          <p className="text-sm mb-4" style={{ color: t.metaColor }}>
            Không tìm thấy sản phẩm.
          </p>
          <Link
            href="/products"
            className="text-sm font-semibold hover:opacity-75"
            style={{ color: t.breadcrumbActiveColor }}
          >
            ← Quay lại danh mục
          </Link>
        </div>
    ...
    <main className="flex-1 min-h-screen" style={{ background: t.bg }}>
      <div className="max-w-[1200px] mx-auto px-4 py-12 sm:py-16">
        ...
        <div className="flex flex-col lg:flex-row gap-12 xl:gap-16">
          ...
          >
            <div
              className="rounded-2xl shadow-sm p-6 flex items-center justify-center aspect-square overflow-hidden group"
              ...
              <div className="relative w-full h-full transition-transform duration-300 group-hover:scale-[1.03]">
                {product.image ? (
                  ...
                  <div
                    ...
                    style={{ background: t.imagePlaceholderBg }}
                  />
                )}
              </div>
            </div>
          ...
          >
            ...
            <div className="flex items-center gap-3 text-sm">
              ...
              <span style={{ color: t.metaColor }}>
                ...
                <span
                  className="font-semibold"
                  style={{
                    color: product.available !== false ? "#22c55e" : "#ef4444",
                  }}
                >
            ...
            <div
              ...
              style={{
                ...
                borderColor: t.descriptionBorder,
              }}
            >
              {product.description ? (
                ...
                <div
                  dangerouslySetInnerHTML={{
                    __html: product.bodyHtml || detail.description,
                  }}
                />
              )}
            </div>
            ...
            >
              <button
                ...
                style={{
                  borderColor: t.addCartBorder,
                  color: t.addCartColor,
                  background: t.addCartBg,
                }}
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = t.addCartHoverBg;
                  e.currentTarget.style.color = t.addCartHoverColor;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = t.addCartBg;
                  e.currentTarget.style.color = t.addCartColor;
                }}
              >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = t.buyNowHoverBg;
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = t.buyNowBg;
                }}
              >
                Mua ngay
              </button>
        ...
        {/* Detail tabs */}
        <div
          className="mt-16 rounded-2xl shadow-sm overflow-hidden"
          style={{ background: t.tabBg }}
        >
          <div
            className="flex"
            style={{ borderBottom: `1px solid ${t.tabBorderColor}` }}
          >
            {[
              ...
              <button
                ...
                style={{
                  borderColor:
                    activeTab === tab.key ? t.tabActiveBorder : "transparent",
                  color:
                    activeTab === tab.key
                      ? t.tabActiveColor
                      : t.tabInactiveColor,
          ...
          <div
            className="p-6 text-sm leading-relaxed min-h-[100px]"
            style={{ background: t.tabContentBg, color: t.tabContentColor }}
          >
          ...
          <div className="mt-16">
            <div className="mb-6">
              <h2
                ...
                style={{ color: t.relatedHeadingColor }}
              >
                SẢN PHẨM LIÊN QUAN
              </h2>
              <div
                className="mt-2 h-1 w-16 rounded-full"
                style={{ background: t.relatedDividerColor }}
              />
            </div>
