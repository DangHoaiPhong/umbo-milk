  ...
  const loginContent = (
    <>
      ...
      <div className="flex justify-between mt-3 text-xs text-gray-500">
        <Link href="/register" onClick={onClose} className="hover:text-[#F7a3a9] transition-colors">
          Tạo tài khoản
        </Link>
        <button
          type="button"
    ...
    <>
      ...
      <div className="flex flex-col items-center mb-5">
        <div className="w-12 h-12 rounded-full bg-[#fff0f1] flex items-center justify-center mb-3">
          <svg className="w-6 h-6 text-[#F7a3a9]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2}
              d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
          </svg>
        </div>
        <h2 className="text-base font-bold text-gray-800 tracking-wide">KHÔI PHỤC MẬT KHẨU</h2>
        {!forgotSent && (
          <p className="text-xs text-gray-400 mt-1 text-center">Nhập email của bạn:</p>
        )}
      </div>
      ...
      {forgotSent ? (
        ...
        <div className="flex flex-col items-center gap-3 py-2">
          ...
          <p className="text-xs text-gray-400 text-center">Vui lòng kiểm tra hộp thư của bạn.</p>
        </div>
      ) : (
        /* Form nhập email */
        <>
          ...
          <p className="text-[10px] text-gray-400 mt-2 leading-relaxed">
            ...
            <a href="https://policies.google.com/privacy" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">Privacy Policy</a>{" "}and{" "}
            <a href="https://policies.google.com/terms" target="_blank" rel="noreferrer" className="text-blue-400 hover:underline">Terms of Service</a>{" "}apply.
          </p>
          <button
