  ...
  return (
    <Link href={`/products/${id}`} className="block w-full h-full">
      ...
      >
        ...
        {/* Image */}
        <div
          className="relative w-full h-48 min-h-[12rem] overflow-hidden rounded-xl mb-4"
        ...
        <div className="flex flex-1 flex-col items-center gap-1 mt-auto">
          <h3
            ...
            onMouseEnter={(e) => {
              e.currentTarget.style.color = nameHover;
            }}
            onMouseLeave={(e) => {
          ...
          <p className="text-xs" style={{ color: volumeColor }}>
            {volume}
          </p>
          {description ? (
            <p
              className="mt-1 text-[11px] leading-5 line-clamp-2 text-center"
